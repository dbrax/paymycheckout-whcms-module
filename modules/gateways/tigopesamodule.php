 ...
 * example file, the filename is "tigopesamodule" and therefore all functions
 * begin "tigopesamodule_".
 *
 ...
 * @return array
 */
function tigopesamodule_MetaData()
{
    return array(
        'DisplayName' => 'Tigopesa Payment Gateway Module',
 ...
 * @return array
 */
function tigopesamodule_config()
{
    return array(
 ...
 * @return string
 */
function tigopesamodule_link($params)
{
 ...
 */
function tigopesamodule_refund($params)
{
    // Gateway Configuration Parameters
    $accountId = $params['accountID'];
    $secretKey = $params['secretKey'];
 ...
 * @return array Transaction response status
 */
function tigopesamodule_cancelSubscription($params)
{
    // Gateway Configuration Parameters
    $accountId = $params['accountID'];
    $secretKey = $params['secretKey'];
